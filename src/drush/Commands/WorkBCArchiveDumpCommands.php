...
class WorkBCArchiveDumpCommands extends DrushCommands
{
    ...
    private function createArchiveFile(array $archiveComponents, array $options): string
    {
        ...
        $process = Process::fromShellCommandline(sprintf('tar zcf "%s" *', $archivePath), $this->archiveDir, null, null, null);
        $process->mustRun();
