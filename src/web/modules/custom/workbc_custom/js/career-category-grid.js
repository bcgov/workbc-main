...
(function ($, Drupal, once) {
  ...
  Drupal.behaviors.exploreGrid = {
    attach: function (context, settings) {
      ...
      $(once('career-category-grid', '#workbc-custom-career-category-grid-form .grid-term')).change(function() {
        const parent = $(this).closest('.fieldset-wrapper');
      ...
      $(once('career-category-grid', document.body)).on('keydown', function (e) {
