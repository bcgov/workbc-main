  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $tooltip = <<<EOS
      <span class="explore-careers--tooltip">
        <a tabindex="0" id="explore-careers--tooltip" class="btn btn-link info-tooltip info-tooltip-inline" role="button" data-bs-toggle="popover" data-bs-container="#explore-careers--tooltip" data-bs-trigger="focus click hover" data-bs-placement="bottom" data-bs-custom-class="workbc-popover--inline" title="{$this->t('Information about NOC codes')}" data-bs-html="true" data-bs-content="{$this->t('The National Occupational Classification System (NOC) is Canada’s national system for describing occupations. Each occupation is assigned a unique five-digit NOC code.')}"></a>
      </span>
    EOS;
