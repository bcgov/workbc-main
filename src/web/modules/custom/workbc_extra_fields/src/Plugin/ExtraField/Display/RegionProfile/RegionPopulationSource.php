 ...
 *
 * @ExtraFieldDisplay(
 *   id = "region_population_source",
 *   label = @Translation("[SSOT] Source: Population"),
 *   description = @Translation("Provenance metadata for field Region Population."),
 *   bundles = {
 *     "node.region_profile",
 *   }
 * )
 */
class RegionPopulationSource extends ExtraFieldDisplayFormattedBase {
  ...
  public function getLabel() {
    ...
    return $this->t('Source: Population');
  }
