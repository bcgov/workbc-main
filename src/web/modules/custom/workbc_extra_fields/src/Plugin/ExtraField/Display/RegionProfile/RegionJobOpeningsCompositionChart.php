 ...
 *   label = @Translation("[SSOT] Job Openings Composition Chart"),
...
class RegionJobOpeningsCompositionChart extends ExtraFieldDisplayFormattedBase {
  ...
  public function viewElements(ContentEntityInterface $entity) {
    ...
    if (!empty($entity->ssot_data) && isset($entity->ssot_data['regional_labour_market_outlook'])) {
      $data = array();
      $data[] = floatval($entity->ssot_data['regional_labour_market_outlook']['replacement_of_retiring_workers_pct']);
      $data[] = floatval($entity->ssot_data['regional_labour_market_outlook']['new_jobs_due_to_economic_growth_pct']);
      $chart = [
