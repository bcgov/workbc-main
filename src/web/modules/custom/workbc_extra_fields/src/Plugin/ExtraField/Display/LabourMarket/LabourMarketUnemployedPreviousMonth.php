      ...
      <div class="lm-data-item lm-has-tooltip">
        ...
        <div class="lm-data-item-value">
          ...
          <span class="lm-tooltip">
            <a tabindex="0" id="lm-tooltip" class="btn btn-link info-tooltip info-tooltip-inline" role="button" data-bs-toggle="popover" data-bs-container="#lm-tooltip" data-bs-trigger="focus click hover" data-bs-placement="bottom" data-bs-custom-class="workbc-popover--inline" title="{$this->t('Information about Participation rate')}" data-bs-html="true" data-bs-content="{$this->t('&lt;em&gt;Participation rate&lt;/em&gt; represents the number of people in the workforce that are of working age as a percentage of total B.C. population.')}"></a>
          </span>
        </div>
      </div>
    </div>
