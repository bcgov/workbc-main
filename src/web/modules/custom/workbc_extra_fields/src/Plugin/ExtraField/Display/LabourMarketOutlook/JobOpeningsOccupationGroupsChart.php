 ...
 *   label = @Translation("[SSOT] Job Openings by Main Occupational Group, B.C."),
 ...
 * )
 */
class JobOpeningsOccupationGroupsChart extends LabourMarketOutLookExtraFieldBase {
  ...
  protected function viewDatasetElement() {
    ...
    $chart = [
      '#chart_id' => 'lmo_report_job_openings_broad_categories_chart',
      '#type' => 'chart',
      '#chart_type' => 'bar',
      '#colors' => array(
        $colorExpansion,
