 ...
 * @ExtraFieldDisplay(
 *   id = "episode_title",
 *   label = @Translation("[SSOT] Episode Title"),
 *   description = @Translation("An extra field to display career Episode Title."),
 *   bundles = {
 *     "node.career_profile",
 *   }
 * )
 */
class CareerEpisodeTitle extends ExtraFieldDisplayFormattedBase {
