...
class CareerProfileJobOpeningsByRegion extends ExtraFieldDisplayFormattedBase {
  ...
  public function viewElements(ContentEntityInterface $entity) {
    ...
    if (!empty($entity->ssot_data) && isset($entity->ssot_data['career_regional'])) {
      ...
      $region['openings'] = ssotFormatNA($entity->ssot_data['career_regional']['cariboo_expected_number_of_job_openings_10y'],0,"",TRUE);
      ...
      $region['openings'] = ssotFormatNA($entity->ssot_data['career_regional']['kootenay_expected_number_of_job_openings_10y'],0,"",TRUE);
      ...
      $region['openings'] = ssotFormatNA($entity->ssot_data['career_regional']['mainland_southwest_expected_number_of_job_openings_10y'],0,"",TRUE);
      ...
      $region['openings'] = ssotFormatNA($entity->ssot_data['career_regional']['north_coast_nechako_expected_number_of_job_openings_10y'],0,"",TRUE);
      ...
      $region['openings'] = ssotFormatNA($entity->ssot_data['career_regional']['northeast_expected_number_of_job_openings_10y'],0,"",TRUE);
      ...
      $region['openings'] = ssotFormatNA($entity->ssot_data['career_regional']['thompson_okanagan_expected_number_of_job_openings_10y'],0,"",TRUE);
      ...
      $region['openings'] = ssotFormatNA($entity->ssot_data['career_regional']['vancouver_island_coast_expected_number_of_job_openings_10y'],0,"",TRUE);
