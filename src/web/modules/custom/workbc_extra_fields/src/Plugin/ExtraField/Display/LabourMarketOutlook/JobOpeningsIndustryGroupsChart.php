 ...
 *   label = @Translation("[SSOT] Top Ten Major Industry Groups by Job Openings, B.C."),
 ...
 * )
 */
class JobOpeningsIndustryGroupsChart extends LabourMarketOutLookExtraFieldBase {
  ...
  public function viewDatasetElement() {
    ...
    $chart = [
      '#chart_id' => 'lmo_report_job_openings_industries_chart',
      '#type' => 'chart',
      '#chart_type' => 'bar',
      '#colors' => array(
        $colorExpansion,
