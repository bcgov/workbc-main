...
class CareerTrekKeywordSearch extends StringFilter {
  ...
  protected function valueForm(&$form, FormStateInterface $form_state) {
    ...
    if ($which == 'all' || $which == 'value') {
      $form['value'] = [
        ...
        '#search_id' => 'career_trek_redux_autocomplete',
        '#additional_data' => [
          'display' => 'block_1',
          'arguments' => [],
          'filter' => 'search',
  ...
  private function search() {
    $index = \Drupal\search_api\Entity\Index::load('career_trek_index');
    $query = $index->query();
    ...
    $query->setFulltextFields(['title', 'field_noc', 'field_location', 'field_region', 'field_description']);
    ...
    $query->addTag('career_trek_search');
