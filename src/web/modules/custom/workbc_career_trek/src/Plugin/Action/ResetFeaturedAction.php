...
/**
 * Reset featured flag of a media entity.
 *
 * @Action(
 *   id = "media_reset_featured",
 *   label = @Translation("Reset featured video")
 * )
 */
class ResetFeaturedAction extends ActionBase implements ContainerFactoryPluginInterface {
  ...
  public function execute($entity = NULL) {
    if ($entity) {
      ...
      $entity->set('field_recently_added', FALSE);
