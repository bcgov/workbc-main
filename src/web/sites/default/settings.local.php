...
if (isset($_SERVER['PROJECT_ENVIRONMENT'])) {
  if ($_SERVER['PROJECT_ENVIRONMENT'] == 'local') {
  ...
  else if ($_SERVER['PROJECT_ENVIRONMENT'] == 'dev') {
  ...
  else if ($_SERVER['PROJECT_ENVIRONMENT'] == 'aws-dev') {
    $config['config_split.config_split.local']['status'] = false;
    $config['config_split.config_split.dev']['status'] = false;
  ...
  else if ($_SERVER['PROJECT_ENVIRONMENT'] == 'aws-test') {
    $config['config_split.config_split.local']['status'] = false;
    $config['config_split.config_split.dev']['status'] = false;
    $config['config_split.config_split.aws_dev']['status'] = false;
  ...
  else if ($_SERVER['PROJECT_ENVIRONMENT'] == 'aws-prod') {
    $config['config_split.config_split.local']['status'] = false;
    $config['config_split.config_split.dev']['status'] = false;
    $config['config_split.config_split.aws_dev']['status'] = false;
    $config['config_split.config_split.aws_test']['status'] = false;
