  ...
  Drupal.behaviors.bannerSwiperCarousel = {
    attach: function (context, settings) {
      ...
      if (video && videoButton) {
        ...
        // Prevent multiple event listeners by removing any previous listener before adding a new one
        if (!videoButton._hasClickListener) {
          videoButton.addEventListener('click', function handler() {
            if (video.paused) {
              video.play();
          ...
          videoButton._hasClickListener = true;
        }
