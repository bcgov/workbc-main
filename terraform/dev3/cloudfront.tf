...
resource "aws_cloudfront_origin_access_control" "oac-dev3" {
  name = "oac-dev3"
...
resource "aws_cloudfront_distribution" "workbc3" {
...
output "cloudfront_url" {
  value = "https://${aws_cloudfront_distribution.workbc3[0].domain_name}"
}
