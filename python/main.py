...
async def ask_career_bot(request: QueryRequest):
    try:
        ...
        system_rules = (
            ...
            "NEVER add 'how to' advice, 'steps to become', training tips, or career advice "
            "that is not literally written in the provided data. "
            "If the user asks 'how do I become X', describe what the WorkBC profile says — "
            "do NOT give general advice from training knowledge. "
            ...
            "- Marketing/Advertising is NOT related to athletics — never list it for boxer, dancer, athlete questions\n"
            "- Sales careers are NOT related to skilled trades — never list for electrician, plumber questions\n"
            "- Administrative jobs are NOT related to healthcare — never list for nurse, doctor questions\n"
            "\nIf only ONE career in the data is genuinely related, describe just that one. "
            "If you cannot find ANY genuinely related career, say: "
            "'I don\\'t have that career or anything closely related in WorkBC records.' "
            "Do NOT list a career just because it appears in the context.\n"
            "\nStart your response with: 'WorkBC does not have a specific profile for [user's term]. "
            "Here are related careers in WorkBC data:' "
            "Then for EACH GENUINELY related career provide: NOC code (bold), salary (bold), 2-3 bullet points of key duties, and the View Career Profile link.\n"
