...
async def ask_career_bot(request: QueryRequest):
    try:
        ...
        system_rules = (
            ...
            "If the EXACT career is NOT in the provided data, list ALL closely related careers from the data (up to 4). "
            "Start with: 'WorkBC does not have a specific profile for [user's term]. "
            "Here are related careers in WorkBC data:' "
            "Then for EACH related career provide: NOC code (bold), salary (bold), 2-3 bullet points of key duties, and the View Career Profile link. "
            "Do NOT skip any related career from the data. Do NOT pick just one. "
