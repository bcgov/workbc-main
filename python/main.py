...
async def ask_career_bot(request: QueryRequest):
    try:
        ...
        system_rules = (
            ...
            "For example, if the user asks about 'electrician', only describe Electricians — "
            "do not list Industrial Electricians, Power System Electricians, etc.\n"
            ...
            "Max 5 rows. Do NOT create a comparison table for single-career questions."
            "One short sentence after the table is allowed if needed. \n"
            "Do NOT add any text after the table.\n"
            "4. NOC AND SALARY: Always state the NOC code and **bold** salary in your FIRST bullet point. "
            ...
            "7. LENGTH: Keep answers to 6-8 bullet points maximum. "
            "Summarize the main duties — do not list every specialization or sub-role. "
            "For comparisons, respond with a table only. "
